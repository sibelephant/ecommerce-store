...
export default function ProductDetail() {
  ...
  return (
    <Layout hideNav>
      ...
      <div className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-4 h-16 bg-background/80 backdrop-blur-xl md:hidden">
        <Button
          variant="ghost"
          size="icon"
      ...
      <div className="px-4 pt-2 pb-32 md:pt-8 md:pb-12">
        <div className="md:grid md:grid-cols-2 md:gap-12 lg:gap-16">
          ...
          {/* Product Info */}
          <div className="animate-fade-up md:flex md:flex-col md:justify-center">
            <div className="mb-6">
              {categoryInfo && (
              ...
              {/* Desktop Add to Cart */}
              <Button
                className="hidden md:flex w-full h-14 text-base font-semibold btn-primary"
      ...
      <div className="fixed bottom-0 left-0 right-0 p-4 bg-card/95 backdrop-blur-xl border-t border-border/50 mobile-safe-bottom animate-slide-in-bottom md:hidden">
        <Button
